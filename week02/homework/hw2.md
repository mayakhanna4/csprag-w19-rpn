...
<a href="/courses/git/1" class="action start">Continue Course</a>
</div>
...
<a class="action start" href="/courses/git/1" title="Scenario 1 - Committing Files">Start Scenario</a>
</div>
<div class="panel scenario git  col s3">
<i class="fa fa-github"></i>
<div class="content">
...
<i class="fa fa-check"></i>
<a class="action start" href="/courses/git/2" title="Scenario 2 - Committing Changes">Start Scenario</a>
</div>
<div class="panel scenario git  col s3">
<i class="fa fa-github"></i>
<div class="content">
...
<i class="fa fa-check"></i>
<a class="action start" href="/courses/git/3" title="Scenario 3 - Working Remotely">Start Scenario</a>
</div>
...
<i class="fa fa-check"></i>
<a class="action repeat" href="/courses/git/6">
<i class="fa fa-sync"></i>
Repeat Scenario
</a>
</div>
...
<i class="fa fa-check"></i>
<a class="action repeat" href="/courses/git/7">
<i class="fa fa-sync"></i>
Repeat Scenario
</a>
</div>
...
<p class="text-right">
<a href="/docs">Documentation</a> | <a href="/blog">Blog</a> | <a href="/press-kit">Press Kit</a> | <a href="/careers">Careers</a> | <a href="/legal">Legal</a> | <a href="http://twitter.com/teamKatacoda" target="_blank" rel="noreferrer">@teamKatacoda</a> | <a href="/cdn-cgi/l/email-protection#d294bda7bcb6b7a0a19299b3a6b3b1bdb6b3fcb1bdbf"><span class="__cf_email__" data-cfemail="bff9d0cad1dbdacdccfff4decbdedcd0dbde91dcd0d2">[email&#160;protected]</span></a>
</p>
</footer>
...
if (window.trackJs) {
trackJs.addMetadata("host", 'ollie02');
...
mixpanel.identify("github_18329933");
mixpanel.people.set({
"$email": "github_18329933",
"$created": "2019-01-26T17:48:08.885Z",
"$last_login": new Date(),
"$name": 'github_18329933',
});
app.set_user({
"id": "",
"username": "e1to2t",
"public_username": "e1to2t",
"email": "github_18329933",
"created_at": "2019-01-26T17:48:08.885Z",
"name": ''
});
}
...
## Question 3
``` 3
commit 3248249e6b7ac4caab01e37850f481450134625f
Author: mayakh <mayakh@umich.edu>
Date:   Sat Jan 26 15:34:16 2019 -0500
...
## Question 6
``` 6
The -nw flag means no window system, so it tells emacs not to open up a new window, and instead opens in the exisiting terminal.
```

## Question 7
``` 7
GIT EDITOR would take priority.
```
